...
class Item			// Item class to get details of an item
{
	String name;
	int quantity;
	double price;
...
class CartMethods			// cartMethods class to define all the methods required for cart
{
	...
	public void billing(FixedProductPromotion fixedProductPromotion, FixedOrderPromotion fixedOrderPromotion)
	{
		...
		System.out.print("Enter promocode(if you have then enter and if you don't have then enter no)  : ");
		Scanner scan = new Scanner(System.in);
		promotionCode = scan.next();
		
		if (promotionCode.equals("no") || promotionCode.equals("NO"))
			return;
...
interface Promotion
{
	enum PromotionEnum
	{
		get10("GET10",1,5),avail10("AVAIL10", 15,20),free10("FREE10", 25,30); //set promotion code
		String code;
		int startDate;
		int endDate;
...
public class ShoppingCart
{
	public static void main(String args[])
	{
		...
		FixedProductPromotion fixedProductPromotion = new FixedProductPromotion(15, 2000.0);	//set the discount limits on basis od number of products
		FixedOrderPromotion fixedOrderPromotion = new FixedOrderPromotion(4000.0);	//set the discount limits on basis of price
		...
		do
		{
			...
			{		
				...
				case 2: 
					...
					String name = sc.next();
					cartMethods.removeItem(name); 
					break;
					
				case 3: 
					cartMethods.updateItem(); 
					break;
					
				case 4: 
					cartMethods.showItems(); 
					break;
					
				case 5: 
					cartMethods.billing(fixedProductPromotion, fixedOrderPromotion);
					break;
