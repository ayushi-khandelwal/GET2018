...
class HexCalc
{
	public String add(String hexNumber1, String hexNumber2)
	{
		...
		return hexAddition.toUpperCase();
	}
	...
	public String subtract(String hexNumber1, String hexNumber2)
	{
		...
		int decSubtract=0;
		String hexSubtract="";
		if(isLess(hexNumber1 , hexNumber2))	// negative output case
		{
...
public class HexCalcMain
{
	public static void main(String args[])
	{
		...
		do
		{
			...
			String hexNumber1 = scan.next().toUpperCase().trim();
			
			System.out.print("Enter second number : ");		
			String hexNumber2 = scan.next().toUpperCase().trim();
